...
/// </summary>
public class TraverseAcl : ITraverseAcl
{
    ...
    private void ApplyAclChange(string path, SecurityIdentifier sid, uint accessMask, int accessMode)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                {
                    ProcessNative.LocalFree(newDacl);
                }
            }
            finally
            {
