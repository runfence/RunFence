...
partial class AclConfigSection
{
    ...
    private DataGridViewCheckBoxColumn Execute;
    ...
    private void InitializeComponent()
    {
        ...
        Execute = new DataGridViewCheckBoxColumn();
        Write = new DataGridViewCheckBoxColumn();
        ...
        _aclModePanel.Size = new Size(445, 50);
        ...
        _folderDepthComboBox.Size = new Size(405, 23);
        ...
        _aclPathLabel.Size = new Size(425, 20);
        ...
        _deniedRightsComboBox.Size = new Size(320, 23);
        ...
        _allowPanel.Size = new Size(450, 175);
        ...
        Account.FillWeight = 60;
        _allowEntriesGrid.Columns.Add(Account);
        Execute.Name = "Execute";
        Execute.HeaderText = "Execute";
        Execute.FillWeight = 20;
        _allowEntriesGrid.Columns.Add(Execute);
        Write.Name = "Write";
        Write.HeaderText = "Write";
        Write.FillWeight = 20;
        _allowEntriesGrid.Columns.Add(Write);
        ...
        _allowConflictLabel.Size = new Size(450, 20);
