...
/// <summary>
/// Service that creates <see cref="AccountPickerStep"/> instances for wizard templates
/// and resolves SID display names for wizard messaging.
/// </summary>
public class WizardAccountPickerService(
