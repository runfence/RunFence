...
public interface IWfpFilterHelper
{
    ...
    /// Throws <see cref="WfpFilterHelperException"/> on unexpected failure; ignores <c>FWP_E_FILTER_NOT_FOUND</c>.
    /// </summary>
    ...
    /// Throws <see cref="WfpFilterHelperException"/> on SDDL or filter-add failure.
    /// </summary>
    ...
    /// Throws <see cref="WfpFilterHelperException"/> on filter-add failure.
    /// </summary>
