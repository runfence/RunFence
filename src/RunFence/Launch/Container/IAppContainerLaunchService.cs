...
/// <summary>
/// Launch, loopback, COM access, and traverse grant operations for AppContainers.
/// </summary>
public interface IAppContainerLaunchService
{
    /// <summary>Launches the app in the AppContainer.</summary>
    void Launch(AppEntry app, AppContainerEntry entry, string? launcherArguments, string? launcherWorkingDirectory = null);
